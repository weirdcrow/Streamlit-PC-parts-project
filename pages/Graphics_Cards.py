...
def gcard1_image():
    image1 = Image.open('./asus_nvidia.jpg')
...
def gcard2_image():
    Image2 = Image.open('./gigabyte_nvidia.jpg')
...
def gcard3_image():
    image3 = Image.open('./zotac_nvidia.jpg')
...
def gcard4_image():
    Image4 = Image.open('./ASUS_NVIDIA_GeForceRTX4090.jpg')
...
def gcard5_image():
    image5 = Image.open('./EVGA_NVIDIA.jpg')
